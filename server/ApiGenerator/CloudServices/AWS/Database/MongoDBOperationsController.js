...
exports.IncrementField = async (req, res) => {
    try {
        ...
        if (!("query" in req.body.payloadInfo) || (req.body.payloadInfo.query == null || !("field" in req.body.payloadInfo) || req.body.payloadInfo.field == null || !("incrementBy" in req.body.payloadInfo) || req.body.payloadInfo.incrementBy == null)) {
            return res.status(400).send({"error": "invalid input"});
        }
...
exports.SetField = async (req, res) => {
    try {
        ...
        if (!("query" in req.body.payloadInfo) || (req.body.payloadInfo.query == null || !("field" in req.body.payloadInfo) || req.body.payloadInfo.field == null || !("value" in req.body.payloadInfo) || req.body.payloadInfo.value == null)) {
            return res.status(400).send({"error": "invalid input"});
        }
...
exports.UpdateArrayElement = async (req, res) => {
    try {
        ...
        if (!("query" in req.body.payloadInfo) || req.body.payloadInfo.query == null || !("field" in req.body.payloadInfo) || req.body.payloadInfo.field == null || !("oldValue" in req.body.payloadInfo) || req.body.payloadInfo.oldValue == null || !("newValue" in req.body.payloadInfo) || req.body.payloadInfo.newValue == null) {
            return res.status(400).send({"error": "invalid input"});
        }
